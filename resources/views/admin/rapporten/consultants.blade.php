    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">Rapport 1 - Kosten per consultant</div>
                    <div class="card-body">
                        <form method="POST" action="/admin/rapporten/consultants">
                            @csrf
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 pt-4">
                    <div class="card">
                        <div class="card-header">Kosten van consultant <strong>{{$geselecteerdeConsultant->name}}</strong></div>
                        <div class="card-body">
